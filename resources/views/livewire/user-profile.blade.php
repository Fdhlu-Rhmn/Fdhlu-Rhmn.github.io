    ...
    <div class="max-w-7xl h-auto items-center rounded overflow-hidden shadow-lg px-5 py-5 md:mx-auto borde justify-center bg-color">
        <form wire:submit.prevent="addData">
            ...
            <div class="mb-6">
                ...
                <input wire:model="weight" type="numeric" id="weight" class="bg-gray-50 border border-g ray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="5 kg" >
            </div>
            <div class="mb-6">
                <label for="token" class="block mb-2 text-sm font-medium warna-text">Token</label>
                <input wire:model="token" type="numeric" id="token" class="bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="100" >
            </div>
            <div class="mb-6">
                <label for="carbon" class="block mb-2 text-sm font-medium warna-text">Carbon</label>
                <input wire:model="carbon" type="numeric" id="carbon" class="bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="100" >
            </div>
