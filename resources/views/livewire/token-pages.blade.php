    ...
    <div class="max-w-7xl h-auto items-center rounded overflow-hidden shadow-lg px-5 py-5 md:mx-auto border bg-color justify-center">
        ...
        <div class="flex justify-between py-2 px-10 space-x-4 space-x-reverse">
            ...
            <div class="bg-color-button items-center py-4 px-6 rounded-md">
                ...
                <div class="text-white text-xl flex items-center justify-center py-2 font-roboto-serif">
                    You received
                </div>
                    ...
                    <div class="bg-color-fonts py-4 px-2 rounded-md flex flex-col">
                        <div class="flex px-6 py-2 space-x-6 justify-between">
                            <div class="flex items-center space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="flex items-center" style="width: 1rem; height: 1rem; font-weight:bold;"> 
                        ...
                        <div class="flex px-6 py-2 space-x-6 justify-between">
                            <div class="flex items-center space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="flex items-center" style="width: 1rem; height: 1rem; font-weight:bold;">
